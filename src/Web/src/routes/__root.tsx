...
import { ThemeProvider, themeInitScript } from "../design-system/theme";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RBI Design System" },
      {
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <HeadContent />
        {/* Applies data-theme before first paint so there is no light/dark flash
         * and the value matches what ThemeProvider computes on mount. */}
