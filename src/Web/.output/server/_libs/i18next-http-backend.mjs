//#region node_modules/.pnpm/i18next-http-backend@4.0.1/node_modules/i18next-http-backend/esm/index.js
var arr = [];
arr.forEach;
arr.slice;
var UNSAFE_KEYS$1 = [
...
var g = typeof globalThis !== "undefined" ? globalThis : typeof global !== "undefined" ? global : typeof window !== "undefined" ? window : void 0;
var fetchApi;
if (typeof fetch === "function") fetchApi = fetch;
else if (g && typeof g.fetch === "function") fetchApi = g.fetch;
var XmlHttpRequestApi = hasXMLHttpRequest() && g ? g.XMLHttpRequest : void 0;
var ActiveXObjectApi = typeof ActiveXObject === "function" && g ? g.ActiveXObject : void 0;
var UNSAFE_KEYS = [
	"__proto__",
	"constructor",
	"prototype"
...
var fetchIt = (url, fetchOptions, callback, altFetch) => {
...
var getDefaults = () => {
	return {
		...
		request,
		reloadInterval: typeof window !== "undefined" ? false : 36e5,
		customHeaders: {},
		queryStringParams: {},
		crossDomain: false,
