...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CRgpRV-K.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-4YZAYmU6.mjs").then((n) => n.s).then((n) => n.t),
		import("./start-BZXiWvQt.mjs"),
		import("./empty-plugin-adapters-BHhFdlcc.mjs")
	]);
	return {
		routerEntry,
		startEntry,
