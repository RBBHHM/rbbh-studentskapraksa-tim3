...
//#region node_modules/.nitro/vite/services/ssr/assets/router-4YZAYmU6.js
var router_4YZAYmU6_exports = /* @__PURE__ */ __exportAll({
	a: () => normalizeLocale,
	c: () => keycloak,
	getRouter: () => getRouter,
	i: () => useLocalization,
...
var keycloak = new Keycloak({
	...
	}["VITE_KEYCLOAK_URL"] ?? "http://localhost:8183",
	realm: {
		"BASE_URL": "/",
		"DEV": false,
		"MODE": "production",
	...
	clientId: {
		...
		"TSS_ROUTER_BASEPATH": "",
		"TSS_SERVER_FN_BASE": "/_serverFn/"
	}["VITE_KEYCLOAK_CLIENT_ID"] ?? "praksa-web"
});
var initialization;
...
//#endregion
export { keycloak as a, useLocalization as c, getAccessToken as i, Route$14 as n, normalizeLocale as o, ThemeContext as r, router_4YZAYmU6_exports as s, Route as t };
